        ...
        <div class="table-responsive">
          <table class="table table-hover mb-0">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <a href="<?php echo e(route('countries.show',$code)); ?>" class="text-decoration-none text-light fw-medium">
    ...
    <div class="card h-100">
      ...
      <div class="card-body p-0">
        ...
        <div class="px-3 py-2 border-bottom">
          ...
          <a href="<?php echo e($news->url); ?>" target="_blank" class="text-decoration-none text-light small fw-medium" style="line-height:1.3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Victus\supply-chain-platform\resources\views\dashboard\index.blade.php ENDPATH**/ ?>