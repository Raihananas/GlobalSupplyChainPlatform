...
<nav class="sidebar" id="sidebar">
  <div class="sidebar-brand align-items-center">
    <?php if(file_exists(public_path('uploads/site/logo.png'))): ?>
        <img src="<?php echo e(asset('uploads/site/logo.png')); ?>?v=<?php echo e(time()); ?>" alt="Logo" style="max-height: 36px; max-width: 36px; object-fit: contain; margin-right: 8px;">
    <?php else: ?>
...
<div class="main-content">
  ...
  <footer class="text-center py-3 border-top border-secondary border-opacity-10 mt-auto bg-white" id="dashboard-footer">
    <span class="text-muted small" id="dashboard-copyright-text">&copy; <?php echo e(date('Y')); ?> <strong>Muslim Gunawan</strong>. All rights reserved.</span>
  </footer>
</div><!-- /main-content -->
...
<?php /**PATH C:\Users\Victus\supply-chain-platform\resources\views\layouts\app.blade.php ENDPATH**/ ?>