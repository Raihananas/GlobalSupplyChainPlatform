  ...
  <div class="card-body p-0">
    <table class="table table-sm table-hover mb-0">
      ...
      <tbody>
        ...
        <tr>
          <td class="small"><?php echo e($snap->countryA->flag_emoji??''); ?> <?php echo e($snap->countryA->name??$snap->country_a); ?></td>
          <td class="text-center small">⚖️</td>
          <td class="small"><?php echo e($snap->countryB->flag_emoji??''); ?> <?php echo e($snap->countryB->name??$snap->country_b); ?></td>
          <td><button class="btn btn-xs btn-outline-success" style="font-size:.7rem;padding:2px 8px"
            onclick="replay('<?php echo e($snap->country_a); ?>','<?php echo e($snap->country_b); ?>')"><?php echo e($snap->recommendation); ?></button></td>
          <td class="text-muted small"><?php echo e($snap->created_at->diffForHumans()); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </tbody>
    </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Victus\supply-chain-platform\resources\views\comparison\index.blade.php ENDPATH**/ ?>