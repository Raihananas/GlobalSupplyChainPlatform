<?php $__env->startSection('title','Data Visualization Dashboard'); ?>
  ...
  <div class="card-body py-3">
    <div class="row g-2 align-items-center">
      ...
      <div class="col-md-6 d-flex gap-2 flex-wrap">
        <?php $__currentLoopData = $countries->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <button class="btn btn-sm btn-outline-secondary" onclick="qViz('<?php echo e($c->code); ?>')">
          <?php echo e($c->flag_emoji); ?> <?php echo e($c->code); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Victus\supply-chain-platform\resources\views\visualization\index.blade.php ENDPATH**/ ?>