...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/news/realtime/dashboard', [NewsController::class,'realtimeDashboard'])->name('news.realtime-dashboard');
    Route::get('/news/worldcup',       [NewsController::class,'worldCupPage'])->name('news.worldcup');
    Route::get('/news/breaking',      [NewsController::class,'breakingNewsPage'])->name('news.breaking');
