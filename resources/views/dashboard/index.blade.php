        ...
        <div class="table-responsive">
          <table class="table table-hover mb-0">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <a href="{{ route('countries.show',$code) }}" class="text-decoration-none text-light fw-medium">
    ...
    <div class="card h-100">
      ...
      <div class="card-body p-0">
        ...
        <div class="px-3 py-2 border-bottom">
          ...
          <a href="{{ $news->url }}" target="_blank" class="text-decoration-none text-light small fw-medium" style="line-height:1.3">
